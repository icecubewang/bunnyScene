...
void main() {
   ...
   if (a_Position.x>-0.05) {
    xoffset = u_DistortionAmp*0.2*(1.0+sin(3.0*u_DistortionTime));
   }
   if (a_Position.z>-0.14) {
    zoffset = u_DistortionAmp*0.5*(1.0+sin(3.0*u_DistortionTime));
   }
